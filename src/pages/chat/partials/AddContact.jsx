...
const AddContact = ({
  ...
  const initialValues = {
    ...
    contactPhone: editContact?.formatcontact || "",
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        if (editContact && typeof contactHandler === "function") {
          const updatedContact = {
            ...editContact,
            firstName: values.firstName,
            lastName: values.lastName,
            email: values.email,
            formatcontact: values.contactPhone,
          };
          contactHandler(updatedContact);
        } else if (typeof contactHandler === "function") {
          contactHandler();
        }
  ...
  const handleContactPhoneChange = (e) => {
    ...
    formik.setFieldValue("contactPhone", raw);
  };
          ...
          <div className="flex gap-4 mb-4">
            ...
            <div className="mb-0">
              <InputComponent
                ...
                value={formatUSPhone(formik.values.contactPhone)}
