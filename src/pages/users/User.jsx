                    ...
                    <td className="border-b-[1px] border-gray-200 px-4 py-2">
                      {item?.extension[0]?.phones?.length > 0 ? (
                        <span className="text-blue-600 cursor-pointer group relative">
                          ...
                          <div className="absolute left-1/2 bottom-full mb-2 -translate-x-1/2 bg-secondary !text-white text-xs rounded px-2 py-1 opacity-0 group-hover:opacity-100 pointer-events-none transition-opacity whitespace-nowrap z-50 min-w-fit">
