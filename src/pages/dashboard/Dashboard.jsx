...
import missedCallsIcon from "../../assets/dashboard/missed3.svg";
    ...
    <>
      <section className="w-[calc(100%-32px)] m-4">
        ...
        <div className="relative flex gap-5 w-full mb-4">
          {initialLoading ? (
            <>
              <div className="relative flex w-full max-w-1/3 bg-white rounded-[12px] h-[300px] animate-pulse p-6">
            ...
            <>
              <div
                className="relative flex w-full max-w-1/3 bg-white rounded-[12px]"
                style={{ boxShadow: "0px 4px 20px rgba(0, 0, 0, 0.1)" }}
              >
                ...
                <tr>
                  ...
                  >
                    <div className="flex justify-center items-center">
                      <div className="animate-spin h-5 w-5 mr-2 border-t-2 border-b-2 border-secondary rounded-full"></div>
                      Loading call data...
                    </div>
                  </td>
                </tr>
